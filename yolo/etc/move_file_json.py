...
base_folder = '/data/ephemeral/home/dataset_yolo/train/labels'  # 원본 이미지 폴더 경로
train_folder = '/data/ephemeral/home/dataset_yolo/train/labels/train'     # train 폴더 경로
val_folder = '/data/ephemeral/home/dataset_yolo/train/labels/val'         # val 폴더 경로
