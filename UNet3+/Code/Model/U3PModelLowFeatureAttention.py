...
class SwinEncoder(nn.Module):
    def __init__(self, in_channels=3, pretrained=True):
        ...
        self.adjust_channels = nn.ModuleList([
            nn.Conv2d(192, 192, 1),     # Stage 1: 192 -> 64
            nn.Conv2d(384, 384, 1),    # Stage 2: 384 -> 256
            nn.Conv2d(768, 768, 1),    # Stage 3: 768 -> 512
            nn.Conv2d(1536, 1536, 1),  # Stage 4: 1536 -> 1024
        ])
...
class UNet_3Plus_DeepSup_LowFeatureAttention(nn.Module):
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        super(UNet_3Plus_DeepSup_LowFeatureAttention, self).__init__()
        self.is_deconv = is_deconv
        self.in_channels = in_channels
        self.is_batchnorm = is_batchnorm
        self.feature_scale = feature_scale

        filters = [192, 384, 768, 1536, 2048]
